<html>
    ...
    <body>
        ...
        <center>
            <h1>文件管理</h1>
            <form action='dir1.php?a=creat' method='post'>
                    ...
                    while(false !== ($f=readdir($dd))){
                        ...
                        echo "<tr>";
                            ...
                            echo "<td align='center'>
                                    <a href='dir1.php?a=edit&filename={$file}'>修改</a>|
                                    <a href='dir1.php?a=del&filename={$file}'>删除</a>
                                  </td>";
                        echo "</tr>";
            ...
            <?php
                if(isset($_GET['a']) && $_GET['a']=='edit'){
                    echo "<hr/>";
                    echo "<form action='dir1.php?a=update' method='post'>";
